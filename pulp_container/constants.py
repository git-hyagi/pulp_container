...
SIGNATURE_PAYLOAD_MAX_SIZE = 10
MANIFEST_PAYLOAD_MAX_SIZE = 4 * MEGABYTE
# MANIFEST_PAYLOAD_MAX_SIZE = 10

RESOURCES_WITH_MAX_SIZE = SimpleNamespace(
    MANIFESTS=MANIFEST_MEDIA_TYPES.IMAGE + MANIFEST_MEDIA_TYPES.LIST,
    SIGNATURES=[SIGNATURE_TYPE.ATOMIC_FULL, SIGNATURE_TYPE.ATOMIC_SHORT],
)
